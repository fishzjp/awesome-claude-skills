...
- [qa-skills](https://github.com/fishzjp/qa-skills) - Full-lifecycle QA framework of 12 skills: requirement analysis, risk-based strategy with a 10-axis type decision matrix, executable case writing and review, Playwright E2E and API automation, bug analysis, regression scoping, and flaky/suite-reliability governance — with pre-registered On/Off measured gains and human-in-the-loop checkpoints. *By [@fishzjp](https://github.com/fishzjp)*
